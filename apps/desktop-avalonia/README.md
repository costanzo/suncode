...
The complete Qt client under `apps/desktop-qt/` is the visual and interaction reference. Avalonia reuses its checked-in logo, icon, traffic-light assets, semantic palette, geometry, and font fallback behavior; Qt is not an Avalonia production dependency.
...
Create the macOS app bundle (including the Qt-derived `.icns` Dock icon) with:
