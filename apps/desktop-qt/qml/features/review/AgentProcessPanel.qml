...
Rectangle {
    ...
    color: cardMode ? "transparent" : theme.inspector
    z: 2
    clip: true
    layer.enabled: true
    ...
    Rectangle { visible: !root.cardMode; anchors.left: parent.left; anchors.top: parent.top; anchors.bottom: parent.bottom; width: 1; color: theme.border }
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout { id: processColumn; anchors.fill: parent; anchors.margins: 13; spacing: 8
                    ...
                    Text { Layout.fillWidth: true; text: client.activeTurnId.length > 0 ? "Turn " + client.activeTurnId : "Waiting for a new turn"; color: theme.textSecondary; font.family: client.activeTurnId.length > 0 ? theme.fontMono : theme.fontUi; font.pixelSize: theme.typeLabel; elide: Text.ElideMiddle }
                    Text { Layout.fillWidth: true; text: "Model  " + client.selectedModel; color: theme.textMuted; font.family: theme.fontMono; font.pixelSize: theme.typeCaption; elide: Text.ElideMiddle }
            ...
            Rectangle {
                ...
                ColumnLayout { id: approvalColumn; anchors.fill: parent; anchors.margins: 13; spacing: 8
                    ...
                    Text { Layout.fillWidth: true; text: client.pendingApproval.operation + "\n" + JSON.stringify(client.pendingApproval.arguments); color: theme.text; font.family: theme.fontMono; font.pixelSize: theme.typeCaption; wrapMode: Text.WrapAnywhere }
                    RowLayout {
                        Layout.fillWidth: true
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    ColumnLayout { id: checkpointBody; anchors.fill: parent; anchors.margins: 9; spacing: 5
                        ...
                        Text { Layout.fillWidth: true; text: modelData.paths.join("\n"); color: theme.textMuted; font.family: theme.fontMono; font.pixelSize: theme.typeCaption; wrapMode: Text.WrapAnywhere; maximumLineCount: 2; elide: Text.ElideRight }
