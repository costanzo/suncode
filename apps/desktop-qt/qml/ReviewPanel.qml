        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text { Layout.fillWidth: true; text: client.pendingApproval.operation + "\n" + JSON.stringify(client.pendingApproval.arguments); color: theme.text; wrapMode: Text.Wrap; textFormat: Text.PlainText; font.pixelSize: theme.typeLabel; lineHeight: 1.2 }
                    RowLayout {
                        Layout.fillWidth: true
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Text { Layout.fillWidth: true; text: modelData.paths.join("\n"); color: theme.textSecondary; wrapMode: Text.WrapAnywhere; textFormat: Text.PlainText; font.pixelSize: theme.typeCaption; lineHeight: 1.15 }
            ...
            ListView { Layout.fillWidth: true; Layout.preferredHeight: Math.min(130, contentHeight); model: client.changedPaths; clip: true; spacing: 3; delegate: Label { required property var modelData; width: ListView.view.width; text: "•  " + modelData; color: theme.textSecondary; elide: Text.ElideMiddle; font.pixelSize: theme.typeCaption } }
            ...
            Text { Layout.fillWidth: true; text: client.baseUrl; color: theme.textSecondary; elide: Text.ElideMiddle; font.pixelSize: theme.typeCaption }
            ...
            Rectangle {
                ...
                Text { id: runtimeStatus; anchors.fill: parent; anchors.margins: 9; text: client.diagnostics.health ? "Runtime  " + client.diagnostics.health.runtime + "\nDatabase  " + (client.diagnostics.health.database.ok ? "Ready" : "Check required") : "Diagnostics unavailable"; color: client.diagnostics.health && client.diagnostics.health.database.ok ? theme.success : theme.warning; font.pixelSize: theme.typeCaption; lineHeight: 1.3 }
            }
