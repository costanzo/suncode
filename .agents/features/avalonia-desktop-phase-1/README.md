...
- Turn-grouped Tool activity inspection with live best-effort output, compact current-tool conversation jump, touched paths, checkpoints, conflict-aware undo, runtime health/diagnostics, provider trace drawer, Git status/diff review, and read-only project dependency Explorer.
