...
pub fn definition() -> (&'static str, &'static str, Value) {
    (
        ...
        json!({"type":"object","required":["pattern"],"properties":{"pattern":{"type":"string","description":"Regular expression to search for"},"path":{"type":"string","description":"Directory or file to search"},"include":{"type":"string","description":"Optional file glob such as **/*.rs"},"limit":{"type":"integer","minimum":1,"maximum":500,"description":"Maximum number of matches to return"}},"additionalProperties":false}),
    )
}
