...
export function PageHeader({ title, description, path, status, tone = "neutral", children }) {
  return (
...
export function DeferredPage({ title, platform, icon, description }) {
  return (
    <>
      ...
      <Section title="Reserved adaptation boundary" description="The directory is intentional; implementation is not implied.">
      ...
      <Section title="Ownership contract">
