...
export function AvaloniaProjectPage() {
  return (
    <>
      ...
      <Section title="Design-to-runtime path" description="React is the review surface; Avalonia remains the presentation runtime.">
        <div className="mapping-flow">
          <div><code>core/tokens/</code><strong>Semantic decisions</strong><span>Color, type, spacing, shape</span></div><span aria-hidden="true">→</span><div><code>components/ + platforms/desktop/</code><strong>Reviewed behavior</strong><span>States, anatomy, platform rules</span></div><span aria-hidden="true">→</span><div><code>apps/desktop-avalonia/</code><strong>Production resources</strong><span>AXAML + C# view models</span></div>
        </div>
      </Section>
      <Section title="Review paths">
