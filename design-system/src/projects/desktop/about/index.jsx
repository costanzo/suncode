...
const aboutGuide = {
  tabs: {
    actions: [
      ...
      "Read the installed product version beneath the SunCode identity.",
    ...
    style: [
      ...
      "The client content is centered with a 64px logo, 12px vertical gaps, a 22px product title, and compact supporting text.",
    ],
    logic: [
      ...
      "The displayed version comes from the desktop application's installed version metadata.",
    ],
  },
};
...
export function AboutPage() {
  ...
  return (
    <>
      <PageHeader
        title="About"
        description="The native-decorated Avalonia window for product identity and installed version."
      ...
      <Section
        id="about-window"
        title="About SunCode"
        description="The operating system supplies the title bar and window controls; the specimen represents the 420 × 320 client area."
      >
        <WorkspaceGuideState
          className="about-guide-state"
          title="About window"
          description="Review the product identity, installed version, native window treatment, and modal behavior."
          guide={aboutGuide}
          side="right"
          open={guideOpen}
