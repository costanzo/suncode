  ...
  return (
    <>
      <PageHeader
        ...
        tone="implemented"
      />
      <Section id="module-index" title="Desktop windows">
        <div className="module-card-grid">
          <ModuleLink
            to="/projects/desktop/project-hub"
            icon="project"
            title="ProjectHub"
            description="Welcome window for recent projects and opening a local folder."
            path="Default 980 × 712 DIP"
          />
          <ModuleLink
            to="/projects/desktop/workspace"
            icon="workspace"
            title="Workspace"
          ...
          <ModuleLink
            ...
            icon="foundation"
            title="Settings"
            description="Configure defaults, appearance, network, logging, and provider credentials."
