...
export function TokensPage() {
  return (
    <>
      ...
      <Section id="colors" title="Color roles" description="The current theme changes values, never meaning.">
      ...
      <Section id="typography" title="Typography" description="Product UI stays sans; machine-readable values alone use mono.">
      ...
      <Section id="spacing" title="Spacing, shape, and controls">
