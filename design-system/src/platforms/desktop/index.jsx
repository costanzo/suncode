...
export function DesktopPlatformPage() {
  return (
    <>
      ...
      <Section id="anatomy" title="Project window anatomy" description="The center remains fluid; supporting bays have bounded widths and can retreat.">
        <div className="desktop-window">
          <div className="desktop-titlebar"><div className="desktop-brand"><img src={compactLogoUrl} alt="" /><strong>SunCode</strong><span>suncode</span></div><div className="window-actions"><i /><i /><i /></div></div>
      ...
      <Section id="ownership" title="Desktop-only ownership">
