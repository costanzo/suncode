...
export function DesktopPlatformPage() {
  return (
    <>
      <PageHeader title="Desktop platform" description="The Phase 1 adaptation layer for the .NET 10 Avalonia client." status="Module index" tone="implemented" showOwnership={false} />
