...
export function SelectionPage() {
  return (
    <>
      <PageHeader
        title="Selection"
        description="Universal selection controls preserve familiar input behavior and visible state."
      ...
      <Section
        ...
        description="Native inputs retain their familiar behavior and visible focus."
      >
      ...
      <Section
        id="dropdowns"
        title="Dropdowns"
        description="Flat choices and provider-grouped models use the same compact menu treatment."
      >
        <DropdownSpecimens />
      </Section>
    </>
