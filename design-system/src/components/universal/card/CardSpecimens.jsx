    ...
    <div className="specimen-grid specimen-grid-3">
      ...
      <div className="card">
        <div className="activity">
          ...
          <div>
            <h3>Reading project files</h3>
            <p>
              Scanning <span className="mono">agent/</span> for provider usage.
            </p>
          </div>
          <small>12s</small>
        </div>
      ...
      <div className="card warning">
        <div className="approval">
          ...
          <div>
            ...
            <p>
              Run <span className="mono">cargo test</span> in this project.
            </p>
          </div>
