      ...
      <Specimen label="Project bay">
        <div className="nav-demo">
          ...
          <div className="nav-item">
            ...
            Sessions<small>3</small>
          </div>
          <div className="nav-item">
            <Icon name="project" />
            Changes<small>8</small>
          </div>
        </div>
      </Specimen>
      <Specimen label="Tabs">
        <div className="tabs" role="tablist" aria-label="Project details">
          {tabs.map((item, index) => (
            <button
              ...
              aria-controls="component-tabpanel"
        ...
        <div
          id="component-tabpanel"
          className="sample-note"
          role="tabpanel"
          aria-labelledby={`component-tab-${tabs.indexOf(tab)}`}
        >
          Selected: {tab}
        </div>
      </Specimen>
      <Specimen label="Segmented view">
        <div className="segmented">
          {["Changes", "All files", "History"].map((item) => (
            <button
              key={item}
              className={`segment ${segment === item ? "active" : ""}`}
        ...
        <p className="sample-note">Selected: {segment}</p>
      </Specimen>
    </div>
  );
}
