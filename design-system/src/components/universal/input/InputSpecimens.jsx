...
export function InputSpecimens() {
  return (
    <div className="specimen-grid specimen-grid-3">
      ...
      <Specimen label="Select and textarea"><div className="stack"><label><span className="field-label">Model</span><SingleDropdown options={[{ value: "deepseek", label: "DeepSeek V4 Pro" }, { value: "claude", label: "Claude Sonnet 5" }]} initialValue="deepseek" ariaLabel="Model" /></label><label><span className="field-label">Instruction</span><textarea className="field" placeholder="Describe the change…" /></label></div></Specimen>
