...
const modules = [
  {
    path: "actions",
    title: "Actions",
    description: "Buttons, action hierarchy, and authority decisions.",
  },
  ...
  },
  {
    path: "data",
    title: "Data",
    description: "Code blocks, tables, and precise technical content.",
  },
  ...
  return (
    <>
      <PageHeader
        ...
        description="Cross-platform primitives are organized into independently addressable modules so each inventory can grow without turning this page into one continuous document."
        status="Module index"
        tone="implemented"
      />
      <Section id="module-index" title="Component modules">
        <div className="module-card-grid">
          {modules.map((module) => (
            <ModuleLink
              key={module.path}
              to={`/components/universal/${module.path}`}
              title={module.title}
